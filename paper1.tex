\chapter{A method to correct upwelling longwave radiation to estimate hemispherical urban surface temperature}\label{paper1}
...
After the LUT is defined, at-sensor spectral radiances for each path length/zenith angle are modeled at an emissivity of 0.95 over a waveband of 0 - 2300 \si{cm^{-1}} for each T\textsubscript{spec}. Profiles of T\textsubscript{air} and humidity are retrieved from 30-minute averages of conditions observed at the Sperrstrasse site. Aerosol, trace gas absorber, and above-sensor T\textsubscript{air} and humidity conditions are defined by the mid-latitude summer standard atmosphere when daytime T\textsubscript{air, max} \textgreater 10 \si{\degreeCelsius} (the mid-latitude winter profile is substituted on days where T\textsubscript{air, max} \textless 10 \si{\degreeCelsius}) \cite{Kantor1962}. 
...
$L_z (T\textsubscript{spec}) $ is representative of at-sensor irradiance upwelling from the urban surface described in SUM at the target specified temperature T\textsubscript{hem, r} for the measured T\textsubscript{air}, humidity, aerosol, and trace gas profile. The process is repeated to retrieve $L_z$ for the range of potential T\textsubscript{hem, r} at the given time-step. Irradiance - T\textsubscript{hem, r} pairings are then aggregated into a LUT. Finally, the measured irradiance from BUBBLE is matched with its closest modeled irradiance to yield an atmospherically corrected, radiometric hemispherical surface temperature for the given time step. The workflow is repeated at 30-minute intervals to yield a continuous time series of T\textsubscript{hem, r}. Atmospheric correction magnitudes can then be calculated as the difference between T\textsubscript{hem, r} and T\textsubscript{hem, b}, with T\textsubscript{hem, b} calculated via:
...
\section{Evaluation of the method using profiles of upwelling longwave radiation over a homogeneous planar surface} \label{sensitivity}

MODTRAN has been shown to effectively model near-ground radiative transfer at urban-scale path lengths in 2-dimensions \cite{Hoch2005} \cite{Hoch2007}. However, the method described in this paper accounts for complex 3-dimensional surface geometry, which can exert significant influence on atmospheric transmittance. In addition, the method includes significant post-processing to weight and integrate point-to-point spectral directional radiances to derive 3-dimensional, hemispherical irradiances. Thus, prior to deriving a climatology of urban T\textsubscript{hem, r}, the method was evaluated using profiles of upwelling longwave irradiances measured over a simple planar surface.
...
\begin{figure}[H]
	...
	height=7in,
	keepaspectratio]{bxsac_season_clima_pres}
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_sd}
%	\caption{Correction magnitude versus the T\textsubscript{hem, r}-T\textsubscript{air} differential for summer months of the study period (April 15\textsuperscript{th} - July 7\textsuperscript{th}). Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_sd}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_wd}
%	\caption{Correction magnitude versus the T\textsubscript{hem, r}-T\textsubscript{air} differential for winter and spring months of the study period (Dec 1\textsuperscript{st} - April 14\textsuperscript{th}). Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_wd}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_sds}
%	\caption{Correction magnitude versus the T\textsubscript{hem, r}-T\textsubscript{air} differential for clear sky summertime days over the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_sds}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_sdc}
%	\caption{Correction magnitude versus the T\textsubscript{hem, r}-T\textsubscript{air} differential for partly cloudy and overcast summertime days over the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_sdc}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_kdown}
%	\caption{Correction magnitude versus incoming shortwave radiation for the daytime hours of the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_kdown}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_them}
%	\caption{Correction magnitude versus T\textsubscript{hem, r} over the duration of the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_them}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_tair}
%	\caption{Correction magnitude versus T\textsubscript{air} over the duration of the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_tair}
%\end{figure}
%
%\begin{figure}[H]
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{corr_abshum}
%	\caption{Correction magnitude versus atmospheric water vapor content for the daytime hours of the study period. Contour shading indicates frequency (higher frequencies in red, lower in yellow).}
%	\label{corr_abshum}
%\end{figure}
...
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{tc_quarts2}
%	\caption{A comparison of T\textsubscript{surf} from sensor geometries described in Table \ref{weightings}. T\textsubscript{surf} is normalized against complete %T\textsubscript{surf}.}
%	\label{tc_quarts}
%\end{figure}
...
%As shown in figure \ref{tc_mean},

%\begin{figure}[H]
%	\centering
%	\includegraphics[width=15cm,
%	height=7in,
%	keepaspectratio]{tc_mean3}
%	\caption{Normalized T\textsubscript{hem, r}, T\textsubscript{plan}, and T\textsubscript{plan} minus T\textsubscript{hem, r} averaged over the IOP and for clear sky and overcast case days.}
%	\label{tc_mean}
%\end{figure}
